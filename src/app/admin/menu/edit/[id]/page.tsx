...
export default function EditMenuPage() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      if (!item) { router.push('/admin/menu'); return }
      ...
      <div className="max-w-2xl mx-auto p-4 md:p-8">
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-3">
            <Logo size={48} />
            <h1 className="text-3xl font-black text-gray-800">Edit Menu Item</h1>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow p-8">
          ...
          {imagePreview && (
            <div className="mb-6 text-center">
              <img
                src={imagePreview}
                alt="Current item"
                className="h-40 w-40 object-cover rounded-2xl mx-auto shadow"
              />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-8">
              <label className="block text-gray-700 font-semibold mb-2">Replace Image</label>
              <input
                ref={fileInputRef}
                type="file"
                accept="image/*"
